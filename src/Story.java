...
public class Story {
        ...
        public Noeud Introduction() {
                ...
                String description = """
                                À la suite d'innombrables années d'ignorance, et malgré les alertes que notre planète nous a envoyé, celle-ci ne pouvait plus encaisser le poids de nos actes.
                                La sécheresse. Issues de l'épuisement de l'ensemble des ressources planétaires, emmena l'humanité dans des tréfonds irréversibles, et l'avènement d'une époque sinistre faisait surface...
                                Désormais, le pétrole et l'eau, étaient les seules denrées qui avaient de la valeur dans ce monde intrépide, en proie à la désolation...
                                """;
        ...
        public Noeud Commencement() {
                ...
                String description = """
                                En tant qu'agent de police, votre rôle est de vous rendre à San Pedro pour récupérer une citerne d'eau, qui pourra donner un espoir de vie à votre colonie.
                                Afin de pouvoir braver cet impitoyable desert et ses dangers, votre équipe vous a spécialement préparé une Dodge Interceptor.
                                À son bord, un V8 compresseur GT Turbo 16 soupapes atmosphérique décranté. Avec ça, vous n'aurez aucun obstacle...
                                """;
                ...
                File[] audio = {
                                ...
                                new File("./assets/sounds/commencement.wav")
                };
        ...
        public Noeud FaireStop() {
                ...
                String description = """
                                Le véhicule approchant peu à peu, vous dicerner une bande de bandit.
                                Vous auriez dû vous cacher...
                                """;
                ;
                ...
                File[] audio = new File[] {
                                new File("./assets/sounds/death.wav"),
                                null
                };
